...
public class CommentsApiTest extends TestWithCurrentUser {
    ...
    public void setUp() throws Exception {
        ...
        var profileData = new ProfileData(user.getId(), user.getUsername(), user.getBio(), user.getImage(), false);
    ...
    public void should_create_comment_success() {
        var param = Map.of(
                "comment", Map.of("body", "comment content")
        );
    ...
    public void should_get_403_if_not_author_of_article_or_author_of_comment_when_delete_comment() {
        var anotherUser = new User("other@example.com", "other", "123", "", "");
        ...
        var token = jwtService.toToken(anotherUser);
